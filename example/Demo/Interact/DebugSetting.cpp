...
bool DebugSetting::IsUseExtRender()
{
    bool use_ext_render = Read(_T("common"), _T("use_ext_render"), false);

    return use_ext_render;
}

bool DebugSetting::IsUseExtCapture()
{
    bool use_ext_capture = Read(_T("common"), _T("use_ext_capture"), false);

    return use_ext_capture;
}

tstring DebugSetting::GetVendor()
{
    tstring vendor = Read(_T("common"), _T("vendor"), _T(""));
