...
public:
    ...
    friend QHVCInteractLocalVideoRenderCallback;
    friend QHVCInteractRemoteVideoRenderCallback;
    friend QHVCInteractAudioFrameCallback;
...
private:
    ...
    // 退出的嘉宾，在updateVideo后清空
    std::vector<std::string> m_vectUIdTempAdd;
    std::vector<std::string> m_vectUIdTempErase;
    ...
    bool m_bUseExtendRender;
    bool m_bUseExtendCapture;
    QHVCInteractLocalVideoRenderCallback* m_pLocalVideoRenderCallback;
    QHVCInteractRemoteVideoRenderCallback* m_pRemoteVideoRenderCallback;
    QHVCInteractAudioFrameCallback* m_pAudioFrameCallback;
    std::string m_strFirstRemoteUserId;
};