...
#pragma region 基本流程
            ...
            *
            * @param roomId           房间Id，长度在64字节以内的字符串。以下为支持的字符集范围: a-z,A-Z,0-9
            * @param userId           用户id, 注意：****必须有是数字，最大9位数字，并保证唯一性
...
#pragma region 自渲染，自采集相关
            ...
            */
            ...
            /**
            * 开启业务做视频数据采集，确保在{@link #LoadEngine}调用前调用，默认关闭。
            */

            QHVC_API int OpenCollectingData();

            /**
            * 关闭数据采集，确保在{@link #LoadEngine}调用前调用
            */
